        ...
        <!-- Cuerpo de la pagina -->
         <div class="cuepo">
            ...
            <div class="ruta">
                ...
                <span class="actual">Usuario</span>
            </div>
            ...
            <div class="primeraPart">
                ...
                <div class="modal" id="modalUsuario">
                    <div class="modal-contenido">
                        ...
                        <br>
                        <form action="addUser.php" method="POST" class="modal-form" id="formAgregarUsuario">
            ...
            <div class="contenedor-usuarios">
                ...
                <div class="card-usuario <?php echo $row['rol'] === 'admin' ? 'card-usuario-admin' : 'card-usuario-gestor'; ?>">
                    ...
                    <div class="usuario-acciones">
                        ...
                        <a href="eliminarUsuario.php?id=<?php echo $row['idUsuario']; ?>"
