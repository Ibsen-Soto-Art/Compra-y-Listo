...
<div class="contenedor">
    ...
    <div class="cuepo">
        <div class="ruta">
            ...
            <span class="actual">Categorías</span>
        </div>
        ...
        <div class="primeraPart">
            ...
            <div class="panelLateral" id="panelLateral">
                ...
                <div class="panelContenido">
                    ...
                    <a href="generarPlantillaCategorias.php" class="accion">
            ...
            <div class="modal" id="modalImportar">
                <div class="modal-import">
                    ...
                    <form id="formImportarCat" enctype="multipart/form-data">
                        ...
                        <a href="generarPlantillaCategorias.php" class="modal-import-plantilla">
            ...
            (function(){
                ...
                document.getElementById("formImportarCat").addEventListener("submit", function(e){
                    ...
                    resultado.innerHTML = "";
                    fetch("importarCategorias.php", { method:"POST", body: new FormData(this) })
                    .then(r => r.json())
                    .then(data => {
    ...
    (function(){
        ...
        formEditar.addEventListener("submit", function(e){
            e.preventDefault();
            fetch("editarCategoria.php", { method:"POST", body: new FormData(formEditar) })
            .then(r => r.json())
            .then(data => {
    ...
    (function(){
        ...
        document.addEventListener("click", function(e){
            ...
            fetch(`deleteCat.php?idCategoria=${id}`)
            .then(r => r.json())
            .then(data => {
                if(data.status === "success"){
                    animarEliminar(id);
        ...
        document.addEventListener("click", function(e){
            ...
            if(!btn) return;
            const id = btn.dataset.id;
            fetch("toggleEstadoCategoria.php", {
                method: "POST",
                headers: {"Content-Type":"application/json"},
    ...
    (function(){
        ...
        confirmarBtn.addEventListener("click", function(){
            ...
            fetch("eliminarVariasCat.php", { method:"POST", body: fd })
            .then(r => r.json())
            .then(data => {
